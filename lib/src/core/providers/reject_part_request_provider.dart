...
final partRequestRepositoryProvider = Provider<PartRequestRepositoryImpl>((ref) {
...
final partRequestRemoteDataSourceProvider = Provider<PartRequestRemoteDataSourceImpl>((ref) {

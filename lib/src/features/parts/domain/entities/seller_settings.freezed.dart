...
SellerSettings _$SellerSettingsFromJson(Map<String, dynamic> json) {
  return _SellerSettings.fromJson(json);
}
...
class _$SellerSettingsImpl implements _SellerSettings {
  ...
  factory _$SellerSettingsImpl.fromJson(Map<String, dynamic> json) =>
      _$$SellerSettingsImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$SellerSettingsImplToJson(
      this,
    );
  }
}
...
abstract class _SellerSettings implements SellerSettings {
  ...
  factory _SellerSettings.fromJson(Map<String, dynamic> json) =
      _$SellerSettingsImpl.fromJson;

...
class SellerChoiceStepPage extends StatefulWidget {
  final Function(String choice) onChoiceSelected;

  const SellerChoiceStepPage({super.key, required this.onChoiceSelected});

  @override
  State<SellerChoiceStepPage> createState() => _SellerChoiceStepPageState();
}

class _SellerChoiceStepPageState extends State<SellerChoiceStepPage> {
  String _choice = '';
              ...
              child: Column(
                ...
                children: [
                  ...
                  SellerSharedWidgets.buildOptionCard(
                    ...
                    icon: SellerSharedWidgets.buildIcon(Icons.directions_car),

  ...
  String _getVehicleInfo(WidgetRef ref) {
    if (_manual) {
      ...
      if (vehicleState.vehicleInfo != null) {
        ...
        return parts.isNotEmpty ? parts.join(' ') : 'Informations véhicule disponibles';
      }
        ...
        child: Column(
          ...
          BecomeSellerSharedWidgets.buildPrimaryButton(
            label: widget.isLoading 
                ? 'Création en cours...' 
                : (widget.onPlateSubmitted != null ? 'Déposer l\'annonce' : 'Suivant'),
            enabled: !widget.isLoading && (_plateController.text.isNotEmpty || _manual || _showVehicleInfo),
